...
namespace PLCReadWrite.PLCControl
{
    ...
    public class PLCControl
    {
        ...
        public ConcurrentDictionary<int, PLCDataCollection<bool>> PlcDataCollectionDictionary = new ConcurrentDictionary<int, PLCDataCollection<bool>>();
        ...
        private bool ReadCollectionBit<T>(ref PLCDataCollection<T> plcDataCollection) where T : struct
        {
            ...
            { 0xff, 0x01 , 0xff, 0x01, 0xff, 0x01, 0xff, 0x01, 0x00, 0x01 ,0xff, 0x01 , 0xff, 0x01, 0xff, 0x01, 0xff, 0x01, 0x00, 0x01 };
